...
terraform {
  ...
  source = "tfr://gitlab.com/arsalanshaikh13/tf-modules-lirw-packer/aws//hosting/route53?version=1.0.0-lirw-packer"
...
inputs = {
  ...
  public_alb_dns_name       = dependency.alb.outputs.public_alb_dns_name
  public_alb_zone_id        = dependency.alb.outputs.public_alb_zone_id
